...
var _SLDateRange = require('../inputs/NotFormsy/SLDateRange');var _SLDateRange2 = _interopRequireDefault(_SLDateRange);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var DateFilter = function DateFilter(_ref) {var column = _ref.column,filter = _ref.filter,onChange = _ref.onChange;
	...
	return (
		_react2.default.createElement(_SLDateRange2.default, {
			id: column.id,
